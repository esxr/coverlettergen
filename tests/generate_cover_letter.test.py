...
requests_data = [
    ...
    },
    {
        ...
        "data": json.dumps({
            ...
            "job_description": "We are looking for a Backend Developer to join our team. Recruiter is Ceril Rogers. The candidate will be responsible for designing and implementing backend systems, optimizing database queries, and ensuring high availability of our services. Interested applicants, please send your resume to crogers@gmail.com. Requirements: ● 2+ years of backend development experience ● Proficiency in Node.js or Django ● Experience with SQL and NoSQL databases ● Familiarity with cloud platforms and serverless architectures ● Strong analytical and debugging skills.",
            "extra_information": ""
        })
    },
    {
    ...
    },
    {
        ...
        "data": json.dumps({
            ...
            "job_description": "We are seeking a Data Scientist to join our analytics team. The candidate will be responsible for analyzing large datasets, developing machine learning models, and presenting insights to stakeholders. Requirements: ● 2+ years of data science experience ● Proficiency in Python or R ● Experience with machine learning algorithms and frameworks ● Familiarity with data visualization tools like Tableau or PowerBI ● Strong analytical and communication skills. Contact Us: Jordan Bell, HR Manager, jbell@recruitment.com.au ",
            "extra_information": ""
        })
    },
    {
